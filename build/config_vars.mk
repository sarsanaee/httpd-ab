...
AP_LIBS = $(MOD_SO_LDADD) $(MOD_HTTP_LDADD) $(MOD_MPM_EVENT_LDADD) /users/alireza/httpd-2.4.46/srclib/apr-util/libaprutil-1.la -lexpat /users/alireza/httpd-2.4.46/srclib/apr/libapr-1.la -luuid -lrt -lcrypt -lpthread -ldl
AP_BUILD_SRCLIB_DIRS = apr apr-util
AP_CLEAN_SRCLIB_DIRS = apr-util apr
HTTPD_VERSION = 2.4.46
HTTPD_MMN = 20120211
abs_srcdir = /users/alireza/httpd-2.4.46
...
APR_INCLUDEDIR = /users/alireza/httpd-2.4.46/srclib/apr/include
APR_VERSION = 1.7.0
APR_CONFIG = /usr/local/apache2/bin/apr-1-config
APU_BINDIR = /usr/local/apache2/bin
APU_INCLUDEDIR = /users/alireza/httpd-2.4.46/srclib/apr-util/include
APU_VERSION = 1.6.1
